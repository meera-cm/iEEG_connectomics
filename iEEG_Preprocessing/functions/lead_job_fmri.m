% fMRI lead mapper (resting_state > first 100 subjects)
%%
function lead_job(opt)
% - Lead-DBS Job created on 11-Apr-2019 15:49:11 -
% --------------------------------------

lead path;

options = getoptslocal;
options.lcm.seeds = opt';
...
options.lcm.odir = 'C:\Users\lfp\Documents\MATLAB\liz\data\fmri\maps';
options.lcm.omask = [];
options.lcm.struc.do = 0;
options.lcm.struc.connectome = 'HCP';
options.lcm.struc.espace = 1;
options.lcm.func.do = 1;
options.lcm.func.connectome = 'resting_state>First 100 subjects';
options.lcm.cmd = 1;
...
options.prefs.lc.datadir = 'C:\lead\connectomes\';
options.prefs.lcm.vatseed = 'binary';
options.prefs.lcm.chunk = 100;
